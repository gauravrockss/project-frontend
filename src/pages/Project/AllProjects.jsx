...
const columns = [
    ...
    { id: 'Project_Lead', label: 'Project lead', minWidth: 150 },
...
const AllProjects = ({ projects, fetchProjects, orgId }) => {
    ...
    const handleConfirmDelete = React.useCallback(
        ...
        [ProjectId, showError, showSuccess, fetchProjects, orgId]
    );
